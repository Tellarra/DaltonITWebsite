...
<body id="body-login">
	...
	echo "<div class='form-group'>";
	echo "<input type='submit' class='btn btn-primary' name='submit' value='Login'>";
...
?>
		...
		<nav>
			<ul>
				...
				<li hidden="true">
					<a title="View Consultant Records" href="../php/viewConsultant.php">View Consultant</a>
				</li>
				<li hidden="true">
					<a title="View Project Records" href="../php/viewProject.php">View Project</a>
				</li>
				<li hidden="true">
					<a title="View Project Consultant Record" href="../php/viewProjectStaff.php">View Project Consultant</a>
				</li>
			</ul>
		</nav>
	</div>
